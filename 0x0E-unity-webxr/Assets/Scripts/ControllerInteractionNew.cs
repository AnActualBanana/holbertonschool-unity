...
{
  public class ControllerInteractionNew : MonoBehaviour
  {
    public GameManager gameManager;
    private FixedJoint attachJoint = null;
    private Rigidbody currentRigidBody = null;
    private BowlingBallBehavior BallBehaviorScript;
    ...
    public void Pickup()
    {
      ...
      if (currentRigidBody.gameObject.GetComponent<BowlingBallBehavior>() != null) //check if object is valid bowling ball
        {
          gameManager.currentBall = currentRigidBody.gameObject;
          BallBehaviorScript = currentRigidBody.gameObject.GetComponent<BowlingBallBehavior>();
          BallBehaviorScript.currentState = BowlingBallBehavior.BallState.Grabbed;
        }
    }
    ...
    public void Drop()
    {
      ...
      if (currentRigidBody.gameObject.GetComponent<BowlingBallBehavior>() != null) //check if object is valid bowling ball
        {
          BallBehaviorScript = currentRigidBody.gameObject.GetComponent<BowlingBallBehavior>();
          BallBehaviorScript.currentState = BowlingBallBehavior.BallState.Thrown;
        }
